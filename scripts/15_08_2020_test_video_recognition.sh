python tools/run_net.py \
	...
	TEST.CHECKPOINT_FILE_PATH /home/ionutc/Documents/Repositories/SlowFast/models/test_model_video_recognition/checkpoints/checkpoint_epoch_00010.pyth \
	OUTPUT_DIR models/test_model_video_recognition \
